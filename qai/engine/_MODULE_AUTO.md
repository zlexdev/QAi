...
cls FuzzIntent(StrEnum): VALID, EMPTY, BOUNDARY, OVERFLOW, MALICIOUS, UNICODE, SCHEMA_VIOLATION
...
_UNSAFE_FILENAME_RE = re.compile('[^a-z0-9]+')
_SLUG_MAX = 60

cls ExplorerResult: visited: list[tuple[StateRef, PageModel]], states: list[StateRef], skipped_destructive: list[CrawlAction], not_visited: list[SkippedPage], budget_exhausted_by: BudgetExhaustedBy | None, screenshots: list[PageScreenshot]
...
_shot_name(index: int, url: str) -> str
